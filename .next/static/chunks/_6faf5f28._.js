    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SubmitFocos.useEffect": ()=>{
            ...
            form.addEventListener('submit', {
                "SubmitFocos.useEffect": async (e)=>{
                    e.preventDefault();
                    const nome = form.name.value;
                    const endereco = form['addrs-foco'].value;
                    const tipo = form['tipo-foco'].value;
                    const imagem = form['add-img'].files[0]?.name || null;
                    // Para simplicidade, usamos lat/lng fixos aqui. Idealmente, você usaria uma API de geocodificação.
                    const lat = -20.4697;
                    const lng = -54.6201;
                    const foco = {
                        nome,
                    ...
                    const res = await fetch('/api/focos', {
                        method: 'POST',
                        headers: {
...
//# sourceMappingURL=_6faf5f28._.js.map